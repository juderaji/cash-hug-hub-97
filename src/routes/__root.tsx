...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Track accounts, plan spending, allocate savings, and understand everyday money decisions with Pocketstead." },
      { property: "og:title", content: "Pocketstead | Personal finance OS" },
      { property: "og:description", content: "Accounts, transactions, savings allocations, planning, and forecasting in one calm personal finance system." },
